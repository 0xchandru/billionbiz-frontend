...
import { ChevronRight, ChevronDown, ChevronUp, Check, UploadCloud, Plus, Trash2, Calendar, Edit2, Monitor, EyeOff, GripVertical, Bell, Cookie } from 'lucide-react';
    ...
    <aside className={`${styles.rightPanel} ${isHidden ? styles.rightPanelHidden : ''}`}>
      {isColorWidgetOpen ? (
        ...
        <>
          ...
          <div className={styles.propTabs} style={{ borderBottom: '1px solid var(--border-color)', background: '#f8fafc' }}>
            {[
              ...
              <div
                ...
                style={{ padding: '12px 6px', cursor: 'pointer', textAlign: 'center', fontSize: '12px' }}
              >
                {tab.label}
              </div>
            ))}
